    ...
    var carousel = function (fieldsValues, contentValue) {
        ...
        function convertTabsToHtml () {
            ...
            $navs.each(function () {
                ...
                html += '<section class="g1-shortcode" data-g1-shortcode-name="carousel_item" data-g1-attrs-list="">'+ $content.val() +'</section>';
            });
        ...
        function parseHtmlToTabsElements (html) {
            ...
            $(html).each(function () {
                ...
                if ($this.is('.g1-shortcode')) {
                    ...
                    var shortcodeName = $this.attr('data-g1-shortcode-name');
...
(function ($, context) {
    ...
    function renderBlock (fieldsValues, contentValue) {
        // content value is a text, not html (with \n instead of <br /> etc)
        if (window.switchEditors && window.switchEditors.wpautop) {
            contentValue = window.switchEditors.wpautop(contentValue);
        }
    ...
    var tabs = function (fieldsValues, contentValue) {
        ...
        function convertTabsToHtml () {
            ...
            $navs.each(function () {
                ...
                html += '<section class="g1-shortcode" data-g1-shortcode-name="tab_title" data-g1-attrs-list="">'+ $navItem.html() +'</section>';
                html += '<section class="g1-shortcode" data-g1-shortcode-name="tab_content" data-g1-attrs-list="">'+ $content.val() +'</section>';
            });
