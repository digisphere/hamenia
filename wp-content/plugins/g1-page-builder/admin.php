...
class G1_Page_Builder_Admin {
    public function __construct() {
        ...
        //add_filter( 'g1_page_builder_wp_editor_content', array( $this, 'wp_editor_convert_new_lines' ) );
    }
    ...
    public function load_wp_editor () {
        ...
        $content = apply_filters( 'g1_page_builder_wp_editor_content', $content );
    ...
    public function wp_editor_convert_new_lines ( $content ) {
        return str_replace("\n\n",'<br><br>', $content);
    }
